...
class TurtleAdventure(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.enemies = [
            ...
            OwnEnemy(self.canvas, size=20, speed=5, position=(CANVAS_WIDTH-500, CANVAS_HEIGHT//2-100, CANVAS_WIDTH-380,CANVAS_HEIGHT//2+100))
...
class OwnEnemy(MovingEnemy):
    ...
    def __init__(self, canvas, size=30, speed=5, position=(45,45,45,45)):
        super().__init__(canvas, size=size, speed=speed)
